...
namespace vladik_kurs
{
    ...
    {
        string text = "В условиях современного мира важно уметь адаптироваться и находить инновационные решения. Путешествуя по дебрям современного общества, необходимо умело использовать мощь технологий и информации. Взаимодействие между человеком и машиной, слияние искусственного интеллекта и человеческого интеллекта, открывают путь к будущему, где границы между реальностью и виртуальностью стираются. Поиски знаний и стремление к совершенству толкают нас вперед в этом веке информации, где сама суть человечности переопределяется.";
         string[] words;
        int counter = 0;
